...
<div class="wraper doc-suport">
	<div class="doc-support-header">
		<h1><?php _e( 'Super Testimonial V-3.0.8', 'ktsttestimonial' ); ?> </h1>
		<p><?php _e( 'Do you have any questions or need assistance? We\'re here to help!', 'ktsttestimonial' ); ?> </p>
	</div>
	<div class="doc-support-content">
		<ul class="items-area">
			<li class="list-item">
				<h3><?php _e( 'Check Documentation', 'ktsttestimonial' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://themepoints.com/testimonials/documentation/"><?php _e( 'Documentation', 'ktsttestimonial' ); ?></a></div>
			</li>
			<li class="list-item">
				<h3><?php _e( 'Show Your Love', 'ktsttestimonial' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://wordpress.org/support/plugin/super-testimonial/reviews/"><?php _e( 'Rate Us Now', 'ktsttestimonial' ); ?></a></div>
			</li>
			<li class="list-item">
				<h3><?php _e( 'Get Customer Support', 'ktsttestimonial' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://www.themepoints.com/questions-answer/"><?php _e( 'Get Support', 'ktsttestimonial' ); ?></a></div>
			</li>
			<li class="list-item">
				<h3><?php _e( 'Buy Us A Coffee', 'ktsttestimonial' ); ?></h3>
				...
				<div class="tps-btn"><a target="_blank" href="https://www.themepoints.com"><?php _e( 'Donate Now', 'ktsttestimonial' ); ?></a></div>
			</li>
		</ul>
	</div>
</div>
