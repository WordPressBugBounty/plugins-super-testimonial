...
<div class="wraper doc-suport">
    <div class="doc-support-header">
        <h1><?php esc_html_e( 'Super Testimonial V-4.0.1', 'ktsttestimonial' ); ?> </h1>
    ...
    <div class="doc-support-content">
        <ul class="items-area">
            <li class="list-item">
                ...
                <div class="tps-btn">
                    <a target="_blank" href="<?php echo esc_url( 'https://themepoints.com/testimonials/documentation/' ); ?>">
            ...
            <li class="list-item">
                ...
                <div class="tps-btn">
                    <a target="_blank" href="<?php echo esc_url( 'https://www.themepoints.com' ); ?>">
