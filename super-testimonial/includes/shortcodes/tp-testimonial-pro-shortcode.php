...
function tp_testimonial_pro_post_query( $atts, $content = null ) {
	...
	$grid_normal_column            = get_post_meta( $postid, 'grid_normal_column', true) ?: '4';
	$grid_laptop_columns           = get_post_meta( $postid, 'grid_laptop_columns', true) ?: '3';
	$grid_tablet_columns           = get_post_meta( $postid, 'grid_tablet_columns', true) ?: '2';
	$grid_mobile_columns           = get_post_meta( $postid, 'grid_mobile_columns', true) ?: '1';
