...
<?php }else { ?>
	...
	<style type="text/css">
		.testimonial-<?php echo esc_attr( $postid ); ?>{
			...
			margin-top: 100px;
			border-top: <?php echo intval( $tp_imgborder_width_option ); ?>px solid <?php echo esc_attr( $tp_imgborder_color_option ); ?>;
			position: relative;
		}
		<?php if($tp_img_show_hide == 1){ ?>
			.testimonial-<?php echo esc_attr( $postid ); ?>{
		...
		.testimonial-<?php echo esc_attr( $postid ); ?> .testimonial-theme5-thumb img{
			border-radius: <?php echo esc_attr( $tp_img_border_radius ); ?>;
			box-shadow: none;
			height: 100%;
			width: 100%;
		...
		.testimonial-<?php echo esc_attr( $postid ); ?> .testimonial-rating {
			margin-top:5px;
			margin-bottom:5px;
		}
