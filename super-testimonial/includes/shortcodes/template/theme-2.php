...
<?php } else { ?>
	...
	<style type="text/css">
		...
		.testimonial-<?php echo esc_attr( $postid); ?> .testimonial-theme2-desc {
		...
		.testimonial-<?php echo esc_attr( $postid); ?> .testimonial-theme2-desc:before {
			content: "\f10d";
		...
		.testimonial-<?php echo esc_attr( $postid); ?> .testimonial-theme2-content {
			display: flex;
	    	align-self: flex-start;
		}
		.testimonial-<?php echo esc_attr( $postid); ?> .testimonial-theme2-thumb {
			width: 100px;
			height: 100px;
			margin-right: 20px;
	...
	<div id="testimonial-slider-<?php echo esc_attr( $postid ); ?>" class="owl-carousel">
		<?php 
			...
			<div class="testimonial-<?php echo esc_attr( $postid ); ?>">
				...
				<div class="testimonial-theme2-content">

					<?php if( has_post_thumbnail() ){ ?>
						<div class="testimonial-theme2-thumb">
					...
					<div class="testimonial-theme2-info-profile">
